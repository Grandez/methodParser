...
#ifndef YY_YY_METHODPARSER_HPP_INCLUDED
# define YY_YY_METHODPARSER_HPP_INCLUDED
// "%code requires" blocks.
#line 32 "..\\grammar\\methodParser.yy"
  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_STRING = 8,                            // STRING
        S_YYACCEPT = 9,                          // $accept
        S_signature = 10,                        // signature
        S_list_parms = 11,                       // list_parms
        S_parm_decl = 12,                        // parm_decl
        S_data = 13,                             // data
        S_method = 14                            // method
      };
    };
...
switch (yykind)
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
      ...
      {
        YY_ASSERT (tok == token::TOK_DATA || tok == token::TOK_COMMA || tok == token::TOK_LPAR || tok == token::TOK_RPAR || tok == token::TOK_ASSIGN || tok == token::TOK_STRING);
      }
#else
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_DATA (std::string v, location_type l)
      {
        return symbol_type (token::TOK_DATA, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_DATA (const std::string& v, const location_type& l)
      {
        return symbol_type (token::TOK_DATA, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
...
#line 1437 "methodParser.hpp"




#endif // !YY_YY_METHODPARSER_HPP_INCLUDED
